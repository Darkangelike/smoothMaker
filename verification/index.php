...
$errorMessage = '<h2>This is an error message</h2>';

$title = '<div class="text-center mt-3"><h1>Please sign in :</h1></div>';
$webContent = '
<form class="text-center mt-5">
    <ul>
        ...
        <li><button class="btn btn-dark" type="submit">Submit</button></li>
